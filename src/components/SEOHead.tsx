...
const SEOHead = ({
  ...
  description = "EMRS 24/7 provides professional ambulance services, licensed medical transport, and home healthcare across the UAE. Fast medical response and compassionate patient transfers by experts.",
