...
const BookAmbulanceDubai = () => {
  const faqs = [
    { question: "How do I book an ambulance in Dubai?", answer: "Call EMRS at +971 50 379 0382 or WhatsApp us. Tell us the patient's condition, pick-up location, and destination. We'll dispatch the right vehicle within minutes." },
    { question: "Can I book an ambulance online in Dubai?", answer: "Yes — WhatsApp us at +971 50 379 0382 for instant booking. You can also call our 24/7 dispatch line for immediate assistance." },
  ...
  return (
    <ServicePageTemplate
      ...
      description="Book a private ambulance in Dubai instantly. Call +971 50 379 0382 or WhatsApp for 24/7 medical transport, patient transfers, and ambulance hire in Dubai."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-xl mx-auto mb-8">
              ...
              <a href="tel:+971503790382" className="text-4xl sm:text-5xl font-black text-accent hover:text-accent/80 transition-colors block mb-4">
                +971 50 379 0382
              </a>
              <div className="flex flex-col sm:flex-row gap-3">
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-white font-bold text-lg flex-1 py-6" asChild>
                  <a href="tel:+971503790382" className="flex items-center justify-center gap-2"><Phone className="w-5 h-5" /> Call Now</a>
                </Button>
                <Button size="lg" className="bg-[#11632B] hover:bg-[#0D4D21] text-white font-bold text-lg flex-1 py-6" asChild>
                  <a href="https://wa.me/971503790382?text=Hi%2C%20I%20need%20to%20book%20an%20ambulance" target="_blank" rel="noopener noreferrer nofollow" className="flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                { step: "1", title: "Call or WhatsApp", desc: "Contact us at +971 50 379 0382. Tell us the patient's condition and location." },
