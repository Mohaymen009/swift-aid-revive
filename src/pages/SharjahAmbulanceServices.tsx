...
const SharjahAmbulanceServices = () => {
  ...
  return (
    <ServicePageTemplate
      ...
      description="Professional ambulance services in Sharjah with trained paramedics. Rapid response, patient transport, and medical escorts across all areas of Sharjah. Call +971 50 379 0382"
