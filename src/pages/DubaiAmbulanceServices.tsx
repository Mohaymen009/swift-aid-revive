...
const DubaiAmbulanceServices = () => {
  const services = [
    {
      ...
      description: "24/7 emergency response with advanced life support (ALS) and basic life support (BLS) units across Dubai.",
      icon: Ambulance
    },
    {
  ...
  const areas = [
    "Downtown Dubai", "Dubai Marina", "Jumeirah", "Al Barsha", "Al Quoz", "Al Qusais",
    "Mirdif", "Jebel Ali", "Dubai Investment Park", "International City", "Motor City",
    "Dubai Silicon Oasis", "Al Nahda", "Al Qouz", "Al Safa", "Umm Suqeim", "Al Wasl",
    "Business Bay", "DIFC", "Jumeirah Lakes Towers (JLT)", "Palm Jumeirah"
  ];

  const faqs = [
    {
      question: "How quickly can an ambulance reach me in Dubai?",
      answer: "Our average response time in Dubai is 15-30 minutes, depending on your location and traffic conditions. We prioritize emergency calls for the fastest response."
    },
    {
      question: "Do you provide ambulance services for events in Dubai?",
      answer: "Yes, we provide medical coverage for events, concerts, and corporate functions throughout Dubai with fully equipped ambulances and trained medical staff."
    },
    {
      question: "Can I book an ambulance in advance for a non-emergency in Dubai?",
    ...
    },
    {
      ...
      answer: "We cover all areas of Dubai including but not limited to Downtown, Dubai Marina, Jumeirah, Al Barsha, and other communities across the emirate."
    },
    {
  ...
  return (
    <ServicePageTemplate
      title="24/7 Ambulance Services in Dubai | Emergency & Patient Transport | EMRS"
      ...
      imageAlt="Ambulance Services in Dubai by EMRS"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block px-4 py-2 bg-accent/20 text-accent rounded-full text-sm font-semibold mb-6">
              24/7 Emergency Response in Dubai
            </span>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Reliable Ambulance Services in Dubai
            </h1>
            <p className="text-xl sm:text-2xl text-white/90 mb-8 leading-relaxed">
              Professional medical transport across all areas of Dubai. Emergency response, inter-hospital transfers, and non-emergency patient transport with trained paramedics and fully equipped ambulances.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                We provide ambulance services to all areas across Dubai, including but not limited to:
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-muted-foreground">
                Don't see your area listed? We cover all of Dubai! Call us to confirm coverage.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-primary mt-4 mb-6">
                Why EMRS is Dubai's Trusted Ambulance Service
              </h2>
            </div>
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row gap-6 p-6 bg-gray-50 rounded-xl">
                <div className="w-full md:w-1/3">
                  ...
                  <p className="text-muted-foreground">
                    Our strategically located ambulances ensure quick response times across Dubai, with an average response time of just 15-30 minutes.
                  </p>
                </div>
                <div className="w-full md:w-1/3">
