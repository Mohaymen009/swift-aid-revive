...
const AbuDhabiAmbulanceServices = () => {
  const services = [
    {
      ...
      description: "24/7 rapid medical response with advanced life support (ALS) and basic life support (BLS) units across Abu Dhabi.",
      icon: Ambulance
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: "Our average response time in Abu Dhabi is 20-35 minutes, depending on your location and traffic conditions. We prioritize critical cases for the fastest response."
    },
    {
  ...
  return (
    <ServicePageTemplate
      ...
      canonical="https://www.emrs.ae/abu-dhabi-ambulance-services"
