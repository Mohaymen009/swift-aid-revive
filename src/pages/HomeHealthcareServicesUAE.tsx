...
const HomeHealthcareServicesUAE = () => {
  ...
  return (
    <ServicePageTemplate
      title="Home Healthcare Services in Dubai & UAE"
      seoTitle="Home Healthcare Services Dubai | Home Nursing UAE | EMRS"
      description="Professional home healthcare services in Dubai and UAE. Licensed doctors, nurses, and physiotherapists providing quality medical care at your doorstep."
      canonical="https://emrs.ae/home-healthcare-services-uae/"

      imageAlt="Home healthcare services in UAE"
