  ...
  return (
    <div className="min-h-screen" id="home">
      <SEOHead 
        ...
        description="Home blood tests, IV therapy, health check-ups in Dubai & UAE. Lab tests at home, vitamin drips, vaccination services. Licensed healthcare at your doorstep. Call +971 4 576 8237"
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                asChild
              >
                <a href="tel:+97145768237" className="flex items-center gap-2" onClick={() => window.gtag_report_conversion('tel:+97145768237')}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              <Button size="lg" className="bg-accent hover:bg-accent/90" asChild>
                <a href="tel:+97145768237" onClick={() => window.gtag_report_conversion('tel:+97145768237')}>Book Blood Test</a>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button variant="outline" asChild>
              <a href="tel:+97145768237" onClick={() => window.gtag_report_conversion('tel:+97145768237')}>Inquire About Corporate Programs</a>
            </Button>
          </div>
        </div>
      </section>
